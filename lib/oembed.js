...
exports.discover = function(options, cb) {
    ...
    if (res.statusCode === 200) {
        var disco = new Discovery(function(href) {
            return resolveUrl(options.uri, href);
        }, cb);
        res.pipe(disco);
    } else
...
exports.fetchXML = function(options, cb) {
    var req = httpGet(options);
    req.on('response', function(res) {
    if (res.statusCode === 200) {
...
exports.fetchJSON = function(options, cb) {
    httpGet(options, function(error, res, body) {
    if (!error &&
        res.statusCode === 200 &&
        body) {
        try {
 ...
 * Main entry point
 */
exports.fetch = function(options, parameters, cb) {
